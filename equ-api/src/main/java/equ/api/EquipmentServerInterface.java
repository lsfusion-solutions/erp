...
public interface EquipmentServerInterface extends RmiServerInterface {
    ...
    void finishRequestExchange(String sidEquipmentServer, Set<Long> succeededRequestsSet) throws RemoteException, SQLException;
    ...
    String sendExtraData(String extraData) throws RemoteException, SQLException;
