...
public class TerminalInfo extends MachineryInfo {
    ...
    public TerminalInfo(boolean enabled, boolean cleared, boolean succeeded, Integer numberGroup, Integer number, String nameModel, String handlerModel, String port, String directory, String idPriceListType) {
