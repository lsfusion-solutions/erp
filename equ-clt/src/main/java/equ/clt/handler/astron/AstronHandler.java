                                ...
                                if (customPaymentType) {
                                    ...
                                    switch (type) {
                                        case 1:
                                            ...
                                            break;
                                        case 2:
                                            String salesBarc = trimToEmpty(rs.getString("SALESBARC"));
                                            String numberGiftCard = null;
                                            try {
                                                numberGiftCard = salesBarc.split(":")[0];
                                            } catch (Exception e){
                                                //todo: temp log
                                                astronSalesLogger.error("error parsing numberGiftCard '" + salesBarc + "'", e);
