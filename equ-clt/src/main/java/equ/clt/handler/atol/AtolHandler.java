...
public class AtolHandler extends DefaultCashRegisterHandler<AtolSalesBatch, CashDocumentBatch> {
    ...
    @Override
    public AtolSalesBatch readSalesInfo(String directory, List<CashRegisterInfo> cashRegisterInfoList) throws IOException {
                        ...
                        if (isPayment) {
                            ...
                            if (dateReceipt == null || startDate == null || dateReceipt.compareTo(startDate) >= 0)
                                currentSalesInfoList.add(getSalesInfo(nppGroupMachinery, numberCashRegister, numberZReport,
                                        dateReceipt, timeReceipt, numberReceipt, dateReceipt, timeReceipt, null, null,
                                        new ArrayList<>(), barcodeItem, null, itemObject, null, quantityReceiptDetail, priceReceiptDetail,
