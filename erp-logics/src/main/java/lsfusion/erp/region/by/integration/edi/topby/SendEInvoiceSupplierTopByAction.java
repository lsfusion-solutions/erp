...
import lsfusion.erp.region.by.integration.edi.SendEInvoiceSupplierAction;
...
public class SendEInvoiceSupplierTopByAction extends SendEInvoiceSupplierAction {
    String provider = "TopBy";

    public SendEInvoiceSupplierTopByAction(ScriptingLogicsModule LM, ValueClass... classes) {
        super(LM, classes);
    }
