...
public class FiscalVMKDisplayTextClientAction implements ClientAction {
    ...
    private static ExecutorService daemonTasksExecutor = Executors.newSingleThreadExecutor(new DaemonThreadFactory("vmk-displayText"));
    String ip;
    int comPort;
    int baudRate;
            ...
            public void run() {
                synchronized (FiscalVMK.lock) {
                    ...
                    try {
                        ...
                        if (FiscalVMK.openPort(ip, comPort, baudRate, 5000)) {
