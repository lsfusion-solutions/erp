...
public class FiscalMercuryUpdateDataActionProperty extends ScriptingActionProperty {

    public FiscalMercuryUpdateDataActionProperty(ScriptingLogicsModule LM) {
    ...
    public void executeCustom(ExecutionContext<ClassPropertyInterface> context) {
        ...
        try {
            ...
            if (context.checkApply()) {
                String result = (String) context.requestUserInteraction(new FiscalMercuryUpdateDataClientAction(baudRate, comPort));
                if (result == null)
                    context.apply();
                else
