...
public class ImportExcelItemsActionProperty extends ImportExcelActionProperty {
    ...
    protected static List<Item> importItems(byte[] file) throws IOException, BiffException, ParseException {
        ...
        for (int i = 1; i < sheet.getRows(); i++) {
            ...
            String brandName = parseString(sheet.getCell(4, i).getContents());
            String idBrand = parseString(sheet.getCell(5, i).getContents());
            String country = parseString(sheet.getCell(6, i).getContents());
            ...
            BigDecimal netWeight = parseBigDecimal(sheet.getCell(10, i).getContents());
            BigDecimal grossWeight = parseBigDecimal(sheet.getCell(11, i).getContents());
            String composition = parseString(sheet.getCell(12, i).getContents());
            ...
            data.add(new Item(idItem, idGroup, name, idUOM, brandName, idBrand, country,
