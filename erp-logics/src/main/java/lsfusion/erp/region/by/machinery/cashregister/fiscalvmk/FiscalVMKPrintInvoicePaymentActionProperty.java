...
public class FiscalVMKPrintInvoicePaymentActionProperty extends ScriptingActionProperty {
    ...
    public FiscalVMKPrintInvoicePaymentActionProperty(ScriptingLogicsModule LM, ValueClass... classes) throws ScriptingModuleErrorLog.SemanticError {
        super(LM, classes);
    ...
    public void executeCustom(ExecutionContext<ClassPropertyInterface> context) throws SQLException, SQLHandledException {
        ...
        try {
            ...
            Object result = context.requestUserInteraction(new FiscalVMKPrintInvoicePaymentClientAction(logPath, ip, comPort, baudRate, placeNumber, null, sumPayment, typePayment, true));
            if(result != null)
