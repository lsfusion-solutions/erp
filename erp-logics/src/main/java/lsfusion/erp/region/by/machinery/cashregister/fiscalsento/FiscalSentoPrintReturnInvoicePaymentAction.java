...
public class FiscalSentoPrintReturnInvoicePaymentAction extends DefaultIntegrationAction {
    ...
    public FiscalSentoPrintReturnInvoicePaymentAction(ScriptingLogicsModule LM, ValueClass... classes) {
        super(LM, classes);
    ...
    public void executeInternal(ExecutionContext<ClassPropertyInterface> context) throws SQLHandledException {
        ...
        try {
            ...
            if(result == null)
                ...
                ServerLoggers.systemLogger.error("FiscalSentoPrintReturnInvoicePayment Error: " + result);
