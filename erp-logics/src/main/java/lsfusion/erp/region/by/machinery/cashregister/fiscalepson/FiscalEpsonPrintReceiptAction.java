    ...
    public void executeInternal(ExecutionContext<ClassPropertyInterface> context) throws SQLHandledException {
        ...
        try {
            ...
            if (skipReceipt) {
                ...
                Integer modificationType = (Integer) findProperty("modificationTypeCurrentCashRegister[]").read(context);
                        ...
                        PrintReceiptResult result = (PrintReceiptResult) context.requestUserInteraction(
                                new FiscalEpsonPrintReceiptClientAction(comPort, baudRate, isReturn,
                                        new ReceiptInstance(sumCash == null ? null : sumCash.abs(),
                                                ...
                                                isReturn ? receiptReturnItemList : receiptSaleItemList, comment), cardType, giftCardType, modificationType));
