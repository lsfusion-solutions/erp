...
public class CreateExcelTemplateLegalEntitiesAction extends CreateExcelTemplateAction {

    public CreateExcelTemplateLegalEntitiesAction(ScriptingLogicsModule LM) {
        super(LM);
    }
