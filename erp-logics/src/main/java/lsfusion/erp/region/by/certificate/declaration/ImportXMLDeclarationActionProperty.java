...
public class ImportXMLDeclarationActionProperty extends DefaultImportActionProperty {
                ...
                DataObject declarationObject = context.getDataKeyValue(declarationInterface);
                    ...
                    if (declaration != null) {
                        ...
                        if (declaration.declarationDate != null)
                            findProperty("date[Declaration]").change(declaration.declarationDate, context, declarationObject);
                        if (declaration.declarationNumber != null)
                            findProperty("number[Declaration]").change(declaration.declarationNumber, context, declarationObject);
    ...
    private Declaration getDeclaration(Document document) {
        List<List<Object>> data = new ArrayList<>();

        Element rootNode = document.getRootElement();
        if (rootNode.getName().equals("DT")) {
            rootNode = rootNode.getChild("Declarant");
            if (rootNode != null) {
                rootNode = rootNode.getChild("ESADout_CU", rootNode.getNamespace("ESADout_CU"));
            }
        }
        if (rootNode != null) {
            ...
            if (rootNode != null) {
                ...
                return new Declaration(data, declarationDate, declarationNumber);
            }
        }
        return null;
    }
    ...
    private class Declaration {
        ...
        public Declaration(List<List<Object>> data, Date declarationDate, String declarationNumber) {
            this.data = data;
