...
// xxx is formula
// a is default value
public abstract class ExportExcelXSSFPivotAction extends InternalAction {
    String idForm;
    ...
    public ExportExcelXSSFPivotAction(ScriptingLogicsModule LM, String idForm, String idGroupObject,
    ...
    public ExportExcelXSSFPivotAction(ScriptingLogicsModule LM, String idForm, Integer titleRowHeight, String idGroupObject,
                                      List<String> rows, List<String> columns, List<String> filters, List<String> cells,
                                      ValueClass... classes) {
    ...
    public ExportExcelXSSFPivotAction(ScriptingLogicsModule LM, String idForm, String titleProperty, Integer titleRowHeight, String idGroupObject,
                                      List<String> rows, List<String> columns, List<String> filters, List<String> cells,
                                      ValueClass... classes) {
    ...
    public ExportExcelXSSFPivotAction(ScriptingLogicsModule LM, String idForm, String titleProperty, String idGroupObject,
                                      List<String> rows, List<String> columns, List<String> filters, List<String> cells,
                                      ValueClass... classes) {
    ...
    public ExportExcelXSSFPivotAction(ScriptingLogicsModule LM,
        ...
        if (fields != null) {
            for (List<String> fieldsEntry : fields) {
                ...
                for (String field : fieldsEntry) {
                    ...
                    resultEntry.add(Arrays.asList((fieldValue == null ? field : fieldValue), formula, caption, numberFormat, columnWidth, columnTotalWidth));
                }
