// a local copy of the platform OverJDBField (before 7.0, when it was moved off com.hexiong.jdbf),
// so that this code works with any platform version; the erp modules declare the org.jdbf dependency themselves
